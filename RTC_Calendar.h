...
extern unsigned char INCREBINBYTE(unsigned char);
extern unsigned int INCREBINWORD(unsigned int);
extern unsigned int ADDBCDWORD(unsigned int,unsigned int);
extern unsigned int SUBBCDWORD(unsigned int,unsigned int);
