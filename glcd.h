...
#define GLCD_CMD_COLUMN_LOWER       0x0
...
// Function written just to draw menu items quickly by me
#define GLCD_MENU_NORMAL 0x00
#define GLCD_MENU_INVERT 0x01
#define GLCD_MENU_TOPBORDER 0x02

INT8U glcd_draw_menu_item(INT8U page, INT8S x,const INT8U *data,INT8U size, INT8U options);

INT8S glcd_draw_int(INT8U page,INT8S x,INT32U num,INT8U minpredec, INT8U addBorder,INT8U decimals, const INT8U *fnt[], INT8U width);

INT8S glcd_draw_digit(INT8U page,INT8S x,INT8U num, INT8U addBorder, const INT8U *fnt[], INT8U width);
